...
URL:		http://search.cpan.org/dist/Regexp-Cherokee/
...
Moduł Regexp::Cherokee dostarcza definicje klas znaków w stylu POSIX
działające z pismem sylabicznym Cherokee. Klasy znaków dostarczone
przez pakiet Regexp::Cherokee odpowiadają własnościom pisma i są
